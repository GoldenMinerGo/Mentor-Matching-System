...
groups = [
	{:title => 'group 1', :admin_id => Parent.find(1).id, :mentor_id => Mentor.find(1).id, :time_slot => '0x857142,0x571428,0x714285,0x428571,0xFABC0,0xEAE990,0xABACADA', :competitions => 'FLL', :description => '...', :visible => true},
	
	{:title => 'group 2', :admin_id => Parent.find(2).id, :mentor_id => Mentor.find(2).id, :time_slot => '0x857142,0x571428,0x714285,0x428571,0xFABC0,0xEAE990,0xABACADA', :competitions => 'Junior FLL', :description => '...', :visible => true}
]
